...
public class IndexedString_ESTest extends IndexedString_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      IndexedString indexedString0 = new IndexedString("W.Kyj*,");
  ...
  public void test2()  throws Throwable  {
      IndexedString indexedString0 = new IndexedString("dHBwd+");
      char[] charArray0 = new char[2];
      charArray0[0] = 'd';
      int int0 = indexedString0.indexOf(charArray0);
      assertEquals((-1), int0);
  ...
  public void test4()  throws Throwable  {
      IndexedString indexedString0 = new IndexedString("T4*V!-^}ftt}?Jq>");
